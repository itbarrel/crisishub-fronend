...
export const eEMAIL_USER = "The provided email address has already been registered";
export const eEMAIL = "A Player has already been registered with the provided email address";
export const eTwitch = "A Player has already been registered with the provided twitch channel";
export const eNick = "A Player has already been registered with the provided Game Name";
...
export const eCURRENT_PASS_NOT_VALID = "Provided current password is not correct";
...
export const vNEW_AND_CONFIRM_PASS_MISMATCH = "New password and Confirm password should be same";

// success alert messages
export const sRESET_PASS_EMAIL_SENT = "Password reset link emailed at your email";
...
export const sNO_FOLLOWER_FOUND = "You are not follered by any one. follower case ";
