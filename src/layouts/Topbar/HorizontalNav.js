...
const HorizontalNav = () => {
  ...
  return (
    ...
    <Menu
      ...
      mode="horizontal">
      <SubMenu popupClassName={'gx-menu-horizontal gx-submenu-popup-curve'} key="main"
      ...
      <SubMenu popupClassName={getNavStyleSubMenuClass(navStyle)} key="in-built-apps"
        ...
        <Menu.Item key="in-built-apps/mail">
          <Link href="/in-built-apps/mail"><i className="icon icon-email" /><IntlMessages
        ...
        <Menu.Item key="in-built-apps/contacts">
          <Link href="/in-built-apps/contacts"><i className="icon icon-contacts" /><IntlMessages
